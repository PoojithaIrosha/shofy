                                                    ...
                                                    <ul class="tp-submenu tp-mega-menu mega-menu-style-2">
                                                        ...
                                                        <li class="has-dropdown">
                                                            ...
                                                            <ul class="tp-submenu">
                                                                ...
                                                                <li><a href="${BASE_URL}user/wishlit">Wishlist</a></li>
                    ...
                    <div class="col-xl-6 col-lg-8">
                        <div class="tp-login-wrapper">
                            <div class="tp-login-top text-center mb-30">
                                ...
                                <p>Do not have an account? <span><a href="${BASE_URL}auth/register">Create a free account</a></span>
                                </p>
                            </div>
                            <div class="tp-login-option">
                                <div class="tp-login-social mb-30 d-flex flex-wrap align-items-center justify-content-center">
                                    <div id="g_id_onload"
                                ...
                                <div class="tp-login-bottom">
                                    <button class="tp-login-btn w-100" onclick="signIn();">Login</button>
                                </div>
                            </div>
                        </div>
                    </div>
