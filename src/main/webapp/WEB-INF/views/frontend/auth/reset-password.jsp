...
<layout:extends name="base">
    ...
    <layout:put block="title" type="REPLACE">
        <title>Reset Password - Shofy</title>
    </layout:put>
                        ...
                        <div class="tp-login-wrapper">
                            ...
                            <div class="tp-login-option">
                                <div class="tp-login-input-wrapper">
                                    <input type="hidden" id="code" value="${it}">
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input id="password" type="password" placeholder="shofy@mail.com">
                                        </div>
                                    ...
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input id="confirm-password" type="password" placeholder="shofy@mail.com">
                                        </div>
                                        <div class="tp-login-input-title">
                                ...
                                <div class="tp-login-bottom mb-15">
                                    <button id="sendBtn" type="submit" class="tp-login-btn w-100" onclick="resetPassword()">Reset Password</button>
                                </div>
                            </div>
                        </div>
                    </div>
