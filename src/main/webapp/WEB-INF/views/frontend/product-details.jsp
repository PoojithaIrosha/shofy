...
<layoyt:extends name="base">
    <layoyt:put block="main-content" type="REPLACE">
                        ...
                        <div class="breadcrumb__content p-relative z-index-1">
                           ...
                           <span class="breadcrumb-icon">
                              <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                ...
                                <span><a href="#">${it.category.name}</a></span>
                                <span>${it.name}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-5 col-lg-6">
                            <div class="tp-product-details-wrapper">
                                ...
                                <h3 class="tp-product-details-title">${it.name}</h3>

                                <!-- inventory details -->
                                <div class="tp-product-details-inventory d-flex align-items-center mb-10">
                                    <div class="tp-product-details-stock mb-10">
                                        <span>${it.quantity > 0 ? "In Stock" : "Out of Stock"}</span>
                                    </div>
                                ...
                                <p>${it.description}... <a href="#nav-description-tab">See more</a></p>
                                <h6>${it.quantity} Qty Available</h6>
