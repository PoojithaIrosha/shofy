...
<%
    ...
    request.setAttribute("orders", it.get("orders"));
%>
                                        ...
                                        <div class="profile__password">
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-6 col-md-6">
                                                    <div class="profile__btn">
                                                        <button type="submit" class="tp-btn"
                                                                onclick="updatePassword('${user.email}');">Update
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                             ...
                                             <span>
                                                <svg enable-background="new 0 0 32 32" viewBox="0 0 32 32"><g><path
                                                        ...
                                                        <div class="profile__address-content">
                                                            ...
                                                            <p><span>Line 1:</span>${user.userAddress.addressLine1}</p>
                                                            <p><span>Line 2:</span>${user.userAddress.addressLine2}</p>
                                                            <p><span>City:</span>${user.userAddress.city}</p>
                                                            </p>
                                                            <p><span>Phone number:</span>${user.mobileNumber}</p>
                                                            <p><span>Zip code:</span>${user.userAddress.zipCode}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <table class="table">
                                                ...
                                                <c:forEach items="${orders}" var="order">
                                                    <tr>
                                                        ...
                                                        <td data-info="title">${order.orderItems.get(0).product.name}</td>

                                                        <td data-info="status pending">${order.orderStatus}</td>

                                                        <td><a href="${BASE_URL}user/order/success/${order.orderId}" class="tp-logout-btn">Invoice</a></td>
                                                    </tr>
                                                </c:forEach>
