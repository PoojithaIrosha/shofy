            ...
            <div class="container">
                <div class="profile__inner p-relative">
                    <div class="profile__shape">
                        <img class="profile__shape-1" src="${BASE_URL}assets/img/login/laptop.png" alt="">
                        <img class="profile__shape-2" src="${BASE_URL}assets/img/login/man.png" alt="">
                        <img class="profile__shape-3" src="${BASE_URL}assets/img/login/shape-1.png" alt="">
                        <img class="profile__shape-4" src="${BASE_URL}assets/img/login/shape-2.png" alt="">
                        <img class="profile__shape-5" src="${BASE_URL}assets/img/login/shape-3.png" alt="">
                        <img class="profile__shape-6" src="${BASE_URL}assets/img/login/shape-4.png" alt="">
                    </div>
                    <div class="row">
                                ...
                                <nav>
                                    <div class="nav nav-tabs tp-tab-menu flex-column" id="profile-tab" role="tablist">
                                        <button class="nav-link active" id="nav-profile-tab" data-bs-toggle="tab"
                                                ...
                                                class="fa-regular fa-user-pen"></i></span>Profile
                                        </button>
                                        ...
                                        <button class="nav-link" id="nav-password-tab" data-bs-toggle="tab"
                                                ...
                                                class="fa-regular fa-lock"></i></span> Change Password
                                        </button>
                                        ...
                                        <div class="profile__main">
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-md-6">
                                                        <div class="profile__main-inner d-flex flex-wrap align-items-center">
                                                            ...
                                                            <jsp:useBean id="it" scope="request"
                                                                         type="com.poojithairosha.shofy.model.user.User"/>

                                                            <c:if test="${it.picture != null}">
                                                                <div class="profile__main-thumb">
                                                                    <c:if test="${it.googleId == null}">
                                                                        <img src="${it.picture}"
                                                                             alt="">
                                                                    </c:if>
                                                                    <c:if test="${it.googleId != null}">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="profile__main-logout text-sm-end">
                                                            <button onclick="logout();" class="tp-logout-btn">Logout
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="profile__main-info">
                                                ...
                                                <span>
                                                   ...
                                                   <svg enable-background="new 0 0 512 512" viewBox="0 0 512 512"><path
                                                ...
                                                <span>
                                                  ...
                                                  <svg viewBox="0 0 512 512"><path
                                                          ...
                                                          d="M464.857,423H420.891a7,7,0,0,0,0,14h43.966a7,7,0,0,0,0-14Z"/></svg>
                                                </span>
                                                            </div>
                                                ...
                                                <span>
                                                   ...
                                                   <svg viewBox="0 -20 480 480" xmlns="http://www.w3.org/2000/svg"><path
                                                ...
                                                <span>
                                                   ...
                                                   <svg viewBox="0 0 512 512"><path
                                                           ...
                                                           d="m291.746 237.835c-13.546 8.525-20.164 18.855-20.439 19.291a6 6 0 0 0 10.134 6.427c.9-1.4 22.609-34.215 69.86-22.527a6 6 0 0 0 2.883-11.648c-29.072-7.193-50.001.628-62.438 8.457z"/><path
                                                           d="m405.6 174.293a6 6 0 0 0 4.6-11.084c-42.714-17.727-73.759-4.452-92.28 9.808a112.488 112.488 0 0 0 -29.868 35.246 6 6 0 1 0 10.748 5.337 101.191 101.191 0 0 1 26.44-31.075c23.288-17.925 50.325-20.697 80.36-8.232z"/><path
                                                           d="m338.178 129.844a6 6 0 0 0 3.862 7.555 90.163 90.163 0 0 0 25.438 3.676c10.034 0 21.623-1.811 32.015-7.971 13.6-8.058 22.32-21.787 25.934-40.8a6 6 0 1 0 -11.789-2.24c-2.938 15.461-9.738 26.46-20.211 32.69-19.921 11.853-47.267 3.367-47.7 3.229a6 6 0 0 0 -7.549 3.861z"/><path
                                                           d="m258.867 284.873a10.806 10.806 0 1 0 -10.805-10.806 10.819 10.819 0 0 0 10.805 10.806zm0-12a1.195 1.195 0 1 1 -1.194 1.194 1.2 1.2 0 0 1 1.194-1.194z"/><path
                                                           d="m343.887 88.873a10.806 10.806 0 1 0 -10.806-10.806 10.818 10.818 0 0 0 10.806 10.806zm0-12a1.195 1.195 0 1 1 -1.195 1.194 1.2 1.2 0 0 1 1.195-1.194z"/><path
                                                           d="m496.194 80.633a10.806 10.806 0 1 0 10.806 10.805 10.817 10.817 0 0 0 -10.806-10.805zm0 12a1.195 1.195 0 1 1 1.195-1.195 1.2 1.2 0 0 1 -1.195 1.195z"/><path
                                                           d="m254.444 224.027a10.806 10.806 0 1 0 -10.8 10.806 10.817 10.817 0 0 0 10.8-10.806zm-10.8 1.2a1.195 1.195 0 1 1 1.194-1.2 1.2 1.2 0 0 1 -1.199 1.195z"/><path
                                                           d="m478.4 230.812a10.806 10.806 0 1 0 10.806 10.806 10.818 10.818 0 0 0 -10.806-10.806zm0 12a1.194 1.194 0 1 1 1.195-1.194 1.2 1.2 0 0 1 -1.195 1.194z"/></svg>
                                                </span>
                                                            </div>
                                                            ...
                                                            <div class="profile__input">
                                                                ...
                                                                <span>
                                                                      <svg width="17" height="19" viewBox="0 0 17 19"
                                                                         ...
                                                                         <path d="M15.5 17.6C15.5 14.504 12.3626 12 8.5 12C4.63737 12 1.5 14.504 1.5 17.6"
                                                                               stroke="currentColor" stroke-width="1.5"
                                                                               stroke-linecap="round"
                                                                               stroke-linejoin="round"/>
                                                                      </svg>
                                                    ...
                                                    <div class="col-xxl-6 col-md-6">
                                                      ...
                                                      <svg width="18" height="16" viewBox="0 0 18 16" fill="none"
                                                         ...
                                                         <path d="M13 14.6H5C2.6 14.6 1 13.4 1 10.6V5C1 2.2 2.6 1 5 1H13C15.4 1 17 2.2 17 5V10.6C17 13.4 15.4 14.6 13 14.6Z"
                                                               ...
                                                               stroke-linejoin="round"/>
                                                         <path d="M13 5.3999L10.496 7.3999C9.672 8.0559 8.32 8.0559 7.496 7.3999L5 5.3999"
                                                               stroke="currentColor" stroke-width="1.5"
                                                               stroke-miterlimit="10" stroke-linecap="round"
                                                               stroke-linejoin="round"/>
                                                      </svg>
                                                        ...
                                                        <div class="profile__input-box">
                                                            <div class="profile__input">
                                                                <input type="text" id="mobileNumber"
                                                                       ...
                                                                       value="${it.mobileNumber}">
                                                                <span>
                                                      <svg width="15" height="18" viewBox="0 0 15 18" fill="none"
                                                           xmlns="http://www.w3.org/2000/svg">
                                                         <path d="M13.9148 5V13C13.9148 16.2 13.1076 17 9.87892 17H5.03587C1.80717 17 1 16.2 1 13V5C1 1.8 1.80717 1 5.03587 1H9.87892C13.1076 1 13.9148 1.8 13.9148 5Z"
                                                               stroke="currentColor" stroke-width="1.5"
                                                        ...
                                                        <div class="profile__input-box">
                                                            <div class="profile__input">
                                                                <input type="text"
                                                                       ...
                                                                       value="${it.userAddress.addressLine1}">
                                                                <span>
                                                                      <svg width="16" height="18" viewBox="0 0 16 18"
                                                                           fill="none"
                                                                           xmlns="http://www.w3.org/2000/svg">
                                                                         <path d="M7.99377 10.1461C9.39262 10.1461 10.5266 9.0283 10.5266 7.64946C10.5266 6.27061 9.39262 5.15283 7.99377 5.15283C6.59493 5.15283 5.46094 6.27061 5.46094 7.64946C5.46094 9.0283 6.59493 10.1461 7.99377 10.1461Z"
                                                                               stroke="currentColor"
                                                                               stroke-width="1.5"/>
                                                                         <path d="M1.19707 6.1933C2.79633 -0.736432 13.2118 -0.72843 14.803 6.2013C15.7365 10.2663 13.1712 13.7072 10.9225 15.8357C9.29079 17.3881 6.70924 17.3881 5.06939 15.8357C2.8288 13.7072 0.263493 10.2583 1.19707 6.1933Z"
                                                                               stroke="currentColor"
                                                                               stroke-width="1.5"/>
                                                                      </svg>
                                                                   </span>
                                                        ...
                                                        <div class="profile__input-box">
                                                            <div class="profile__input">
                                                                <input type="text"
                                                                       ...
                                                                       value="${it.userAddress.addressLine2}">
                                                                <span>
                                                                      <svg width="16" height="18" viewBox="0 0 16 18"
                                                                           fill="none"
                                                                           xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="profile__password">
                                            <div class="row">
                                                <div class="col-xxl-12">
                                                    <div class="tp-profile-input-box">
                                                        <div class="tp-contact-input">
                                                            <input name="old_pass" id="old-pass" type="password">
                                                        </div>
                                                ...
                                                <div class="col-xxl-6 col-md-6">
                                                    <div class="tp-profile-input-box">
                                                        <div class="tp-profile-input">
                                                            <input name="new_pass" id="new-pass" type="password">
                                                        </div>
                                                        <div class="tp-profile-input-title">
                                                ...
                                                <div class="col-xxl-6 col-md-6">
                                                    <div class="tp-profile-input-box">
                                                        <div class="tp-profile-input">
                                                            <input name="con-new-pass" id="con-new-pass"
                                                                   type="password">
                                                        </div>
                                                        <div class="tp-profile-input-title">
                                                            <label for="con-new-pass">Confirm Password</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-6">
                                                    <div class="profile__btn">
                                                        <button type="submit" class="tp-btn"
                                                                onclick="updatePassword('${it.email}');">Update
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="nav-address" role="tabpanel"
                                        ...
                                        <div class="profile__address">
                                            <div class="row">
                                             ...
                                             <span>
                                                <svg enable-background="new 0 0 32 32" viewBox="0 0 32 32"><g><path
                                                        ...
                                                        d="m21.106 22.318c0 1.226.993 2.219 2.219 2.219s2.219-.994 2.219-2.219v-.001c-.002-1.225-.994-2.217-2.219-2.218-1.226 0-2.219.993-2.219 2.219zm2.938-.001c-.002.396-.323.716-.719.717v.002c-.397 0-.719-.322-.719-.719s.322-.719.719-.719.719.322.719.719z"/><path
                                                        d="m23.001 10.145c0-.414-.336-.75-.75-.75h-15.462c-.414 0-.75.336-.75.75s.336.75.75.75h15.463c.414-.001.749-.336.749-.75z"/><path
                                                        d="m6.789 14.216c-.414 0-.75.336-.75.75s.336.75.75.75h10.572c.414 0 .75-.336.75-.75s-.336-.75-.75-.75z"/><path
                                                        d="m12.075 19.039h-5.286c-.414 0-.75.336-.75.75s.336.75.75.75h5.286c.414 0 .75-.336.75-.75s-.336-.75-.75-.75z"/><path
                                                        ...
                                                        <div class="profile__address-content">
                                                            ...
                                                            <p><span>Line 1:</span>${it.userAddress.addressLine1}</p>
                                                            <p><span>Line 2:</span>${it.userAddress.addressLine2}</p>
                                                            <p><span>City:</span>${it.userAddress.city}</p>
                                                            </p>
                                                            <p><span>Phone number:</span>${it.mobileNumber}</p>
                                                            <p><span>Zip code:</span>${it.userAddress.zipCode}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="profile__address-item d-sm-flex align-items-start">
                                                        <div class="profile__address-icon">
                                             <span>
                                                <svg viewBox="0 0 64 64"><g id="ad"><g><path
                                                        d="m50 49c-1.654 0-3 1.346-3 3s1.346 3 3 3 3-1.346 3-3-1.346-3-3-3zm0 4c-.551 0-1-.448-1-1s.449-1 1-1 1 .448 1 1-.449 1-1 1z"/><path
                                                        d="m13 55c1.654 0 3-1.346 3-3s-1.346-3-3-3-3 1.346-3 3 1.346 3 3 3zm0-4c.551 0 1 .448 1 1s-.449 1-1 1-1-.448-1-1 .449-1 1-1z"/><path
                                                        ...
                                                        d="m36 21c3.309 0 6-2.691 6-6s-2.691-6-6-6-6 2.691-6 6 2.691 6 6 6zm0-10c2.206 0 4 1.794 4 4s-1.794 4-4 4-4-1.794-4-4 1.794-4 4-4z"/><path
                                                        d="m43 43h4c.552 0 1-.447 1-1s-.448-1-1-1h-4c-.552 0-1 .447-1 1s.448 1 1 1z"/></g></g></svg>
                                             </span>
                                                        </div>
                                                        <div class="profile__address-content">
