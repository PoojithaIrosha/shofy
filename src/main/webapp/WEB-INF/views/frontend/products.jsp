                                                    ...
                                                    <div class="tp-product-item-2 mb-40">
                                                        ...
                                                        <div class="tp-product-content-2 pt-15">
                                                            ...
                                                            <div class="tp-product-price-wrapper-2">
                                                                <span class="tp-product-price-2 new-price">Rs.${product.price}</span>
                                                                <span class="tp-product-price-2 old-price">Rs.${product.price + (product.price / 10) * 100}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="${BASE_URL}assets/img/product/list/product-list-1.jpg"
                                                                     alt="">
                                                            </a>
                                                        ...
                                                        <div class="tp-product-list-content">
                                                            <div class="tp-product-content-2 pt-15">
                                                                ...
                                                                <p>Auctor urna nunc id cursus. Scelerisque purus semper
                                                    ...
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="${BASE_URL}assets/img/product/list/product-list-2.jpg"
                                                                     alt="">
                                                            </a>
                                                    ...
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="${BASE_URL}assets/img/product/list/product-list-3.jpg"
                                                                     alt="">
                                                            </a>
                                                    ...
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="${BASE_URL}assets/img/product/list/product-list-4.jpg"
                                                                     alt="">
                                                            </a>
                                                    ...
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="${BASE_URL}assets/img/product/list/product-list-5.jpg"
                                                                     alt="">
                                                            </a>
                                                    ...
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="${BASE_URL}assets/img/product/list/product-list-6.jpg"
                                                                     alt="">
                                                            </a>
                                                    ...
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="${BASE_URL}assets/img/product/list/product-list-7.jpg"
                                                                     alt="">
                                                            </a>
                                    ...
                                    <nav>
                                        <ul>
                                            <c:if test='${(it.get("page") - 1) >= 1}'>
                                                <li>
                                                    <a href="${BASE_URL}products?page=${(it.get("page")-1)}&search=${it.get("search")}" class="tp-pagination-prev prev page-numbers">
